   ...
   <a href="listkerja/{{ $kerja['id'] }}" class="block px-4 py-6 border border-gray-200 rounded-lg">
     {{-- <div class="font-bold text-blue-500 text-sm">
        Perusahaan : {{ $kerja->perusahaan->company_name }}
    </div>
    <div>
        <li><b> {{ $kerja['job_title'] }}:</b> {{ $kerja['location'] }}</li>
    </div>  --}}
    <li class="job-listing d-block d-sm-flex pb-3 pb-sm-0 align-items-center">
        ...
        <div class="job-listing-about d-sm-flex custom-width w-100 justify-content-between mx-4">
          <div class="job-listing-position custom-width w-50 mb-3 mb-sm-0">
            <h2>{{ $kerja['job_title'] }}</h2>
            <strong> {{ $kerja->perusahaan->company_name }}</strong>
          </div>
          <div class="job-listing-location mb-3 mb-sm-0 custom-width w-25">
            <span class="icon-room"></span> {{ $kerja['location'] }}
          </div>
          <div class="job-listing-meta">
            <span class="badge badge-success">{{ $kerja['job_type'] }}</span>
          </div>
        </div>
      </li>
    {{-- <a href="/listkerja/create" class="relative inline-flex items-center px-2 py-2 -ml-px text-sm font-medium text-gray-500 bg-white border border-gray-300 rounded-r-md leading-5 hover:text-gray-400 focus:z-10 focus:outline-none focus:ring ring-gray-300 focus:border-blue-300 active:bg-gray-100 active:text-gray-500 transition ease-in-out duration-150 dark:bg-gray-800 dark:border-gray-600 dark:active:bg-gray-700 dark:focus:border-blue-800">Tambah Pekerjaan</a>
 </a>  --}}
